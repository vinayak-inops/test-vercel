...
export default function LeaveRequestsPopup({ isOpen, onClose, leaveApplications, initialSelectedApplication }: LeaveRequestsPopupProps) {
        ...
        <div className="px-6 pt-6 pb-6 border-b border-gray-200 bg-white">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-semibold text-gray-900">
              {showStatusView ? "Leave Application Status" : "Leave Applications"}
            </h2>
            {showStatusView && (
              <button
