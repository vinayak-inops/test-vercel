...
import { Building2, Hash, Edit3, Copy, ExternalLink, X } from "lucide-react"
import type { Dispatch, SetStateAction } from "react"
import { useState } from "react"

interface DepartmentDetailPopupProps {
  open: boolean
...
export default function DepartmentDetailPopup({ open, setOpen, departmentData }: DepartmentDetailPopupProps) {
  const data = {
  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <div className="relative">
          ...
          <div className="relative flex items-start gap-4 p-6 rounded-2xl border border-gray-100/50 backdrop-blur-sm">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-md font-semibold text-gray-900 truncate mb-1">{data.departmentName}</h1>
              <div className="flex items-center gap-3">
        ...
        {/* Department Information with enhanced cards */}
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-bold text-gray-800 tracking-wide uppercase">Department Information</h2>
