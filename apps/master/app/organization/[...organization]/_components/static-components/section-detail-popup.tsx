...
import { FolderOpen, Hash, Edit3, Copy, ExternalLink, X } from "lucide-react"
...
export default function SectionDetailPopup({ open, setOpen, sectionData }: SectionDetailPopupProps) {
  const data = {
    ...
    >
      <div className="space-y-8">
        ...
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-pink-50/50 to-rose-50/50 rounded-2xl"></div>
          <div className="relative flex items-start gap-4 p-6 rounded-2xl border border-gray-100/50 backdrop-blur-sm">
            <div className="relative">
              <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-500 to-rose-600 shadow-lg shadow-pink-500/25">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-md font-semibold text-gray-900 truncate mb-1">{data.sectionName}</h1>
              <div className="flex items-center gap-3">
                <span className="inline-flex items-center px-3 py-1 text-xs font-semibold bg-gradient-to-r from-pink-50 to-rose-50 text-pink-700 rounded-full border border-pink-200/50 shadow-sm">
                  {data.sectionCode}
                </span>
        ...
        {/* Section Information with enhanced cards */}
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-bold text-gray-800 tracking-wide uppercase">Section Information</h2>
            ...
            <div className="relative border border-gray-200/50 rounded-2xl p-2 backdrop-blur-sm shadow-sm">
              <div className="space-y-1">
                <InfoRow
                  ...
                  icon={<FolderOpen className="w-4 h-4 text-pink-500" />}
                />
                <InfoRow
                  label="Section Code"
