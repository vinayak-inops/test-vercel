...
import { MapPin, Building2, Globe, Hash, Edit3, Copy, ExternalLink, X } from "lucide-react"
...
export default function LocationDetailPopup({ open, setOpen, locationData }: LocationDetailPopupProps) {
  const data = {
    locationCode: "LOC001",
  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <div className="relative">
          ...
          <div className="relative flex items-start gap-4 p-6 rounded-2xl border border-gray-100/50 backdrop-blur-sm">
            ...
            <div className="flex-1 min-w-0">
              <h1 className="text-md font-semibold text-gray-900 truncate mb-1">{data.locationName}</h1>
              <div className="flex items-center gap-3">
        ...
        {/* Location Information with enhanced cards */}
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-sm font-bold text-gray-800 tracking-wide uppercase">Location Information</h2>
          ...
          <div className="relative">
            ...
            <div className="relative border border-gray-200/50 rounded-2xl p-2 backdrop-blur-sm shadow-sm">
              <div className="space-y-1">
                ...
                />
                <InfoRow label="City" value={data.city} icon={<Building2 className="w-4 h-4 text-orange-500" />} />
                <InfoRow label="Pincode" value={data.pincode} icon={<Hash className="w-4 h-4 text-pink-500" />} />
              </div>
            </div>
          </div>
        </div>
