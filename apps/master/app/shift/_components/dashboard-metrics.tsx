...
export default function Component({ itemsPerView = 3 }: DashboardMetricsProps) {
  ...
  const metrics = [
    { title: "Sales", value: "6,390", change: "+2.5%" },
    { title: "Orders", value: "90", change: "+2.5%" },
    { title: "Avg Order Value", value: "348", change: "+2.5%" },
    { title: "Revenue", value: "12,450", change: "+4.2%" },
    { title: "Customers", value: "1,847", change: "+3.1%" },
  ]
      ...
      <div className="w-full">
        ...
        <div className="relative">
          ...
          <div
            ...
            className={`flex gap-6 overflow-x-scroll pt-6 scrollbar-hide pb-4 transition-all duration-1000 ${
